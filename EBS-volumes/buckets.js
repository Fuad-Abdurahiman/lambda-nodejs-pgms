...
async function call() {
    ...
    for (let buckets of bucket_details?.Buckets) {
        ...
        try {
            ...
            let params1 = {
                AccountID : person.Account,   // o/p from getCallerIdentity api call
                Bucket: buckets.Name,
            ...
            console.log("Total Size of the bucket-", buckets.Name, ":", bytes(Total, { unitSeparator: ' ' }))  // to give gap between number and unit
